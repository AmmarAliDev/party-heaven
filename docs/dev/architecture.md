...
- The category menu contract is stable: `Party Heaven` pinned first, other categories sorted by name, and `All Categories` pinned last (in the `More` dropdown) to preserve SEO-friendly listing discoverability at `/categories`.
